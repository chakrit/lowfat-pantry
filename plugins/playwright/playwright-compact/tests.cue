// Golden-file drift tests for playwright-compact, run by chakrit/smoke (>= v0.3.0).
...
//   smoke plugins/playwright/playwright-compact/tests.cue        # UNCHANGED/0 = no drift
//   smoke -c plugins/playwright/playwright-compact/tests.cue     # re-lock intentionally
//
...
_dir: "plugins/playwright/playwright-compact"
_cases: [
