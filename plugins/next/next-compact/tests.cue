// Golden-file drift tests for next-compact, run by chakrit/smoke (>= v0.3.0).
// Source of truth: the smoke golden spec for this plugin.
// Invoke from the REPO ROOT (smoke runs commands in the invocation cwd):
//   smoke plugins/next/next-compact/tests.cue        # UNCHANGED/0 = no drift
//   smoke -c plugins/next/next-compact/tests.cue     # re-lock intentionally
//
...
_dir: "plugins/next/next-compact"
_cases: [
