// Golden-file drift tests for env-compact, run by chakrit/smoke (>= v0.3.0).
...
//   smoke plugins/env/env-compact/tests.cue        # UNCHANGED/0 = no drift
//   smoke -c plugins/env/env-compact/tests.cue     # re-lock intentionally
//
