// Golden-file drift tests for pip-compact, run by chakrit/smoke (>= v0.3.0).
...
//   smoke plugins/pip/pip-compact/tests.cue        # UNCHANGED/0 = no drift
//   smoke -c plugins/pip/pip-compact/tests.cue     # re-lock intentionally
//
