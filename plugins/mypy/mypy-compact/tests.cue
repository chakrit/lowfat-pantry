// Golden-file drift tests for mypy-compact, run by chakrit/smoke (>= v0.3.0).
// Source of truth: the smoke golden spec for this plugin.
// Invoke from the REPO ROOT (smoke runs commands in the invocation cwd):
//   smoke plugins/mypy/mypy-compact/tests.cue        # UNCHANGED/0 = no drift
//   smoke -c plugins/mypy/mypy-compact/tests.cue     # re-lock intentionally
//
...
_dir: "plugins/mypy/mypy-compact"
_cases: [
